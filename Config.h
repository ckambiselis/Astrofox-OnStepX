/* ---------------------------------------------------------------------------------------------------------------------------------
 * Configuration for OnStepX and JTW Manticore controller on the Astrofox telescope
 *
...
#define CONFIG_NAME "JTW Manticore Astrofox"
#define HOST_NAME                "Astrofox" // nStep", Hostname for this device up to 16 chars.                                 Adjust
...
#define AXIS1_ENCODER      RENISHAW_19BIT
#define AXIS1_ENCODER_REVERSE          ON //
#define AXIS1_ENCODER_COUNTS_PER_DEGREE 1456.355556
...
#define AXIS2_ENCODER      RENISHAW_19BIT
#define AXIS2_ENCODER_REVERSE          ON //
#define AXIS2_ENCODER_COUNTS_PER_DEGREE 1456.355556
